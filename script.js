...
const Q10A = ["125 psig (860 kPa)", "", "", ""]
const Q11A = ["Extruded polyethylene or PVC resin", "", "", ""]
const Q12A = ["Type K copper tubing placed underground, does not need to be coated with any material during the time of manufacture.", "", "", ""]
const Q13A = ["Seamless copper", "", "", ""]
const Q14A = ["CSA CAN1-8.3 or CSA CAN/CGA 8.1", "", "", ""]
const Q15A = ["CAN/CSA-W117.2", "", "", ""]
const Q16A = ["Conforms to a nationally recognized standard or to a test report of a nationally recognized certification organization.", "", "", ""]
const Q17A = ["CSA B137.4", "", "", ""]
const Q18A = ["CSA B137.4 or CSA B137.4.1", "", "", ""]
const Q19A = ["Plastic piping", "", "", ""]
const Q20A = ["Outdoor underground service", "", "", ""]
const Q21A = ["10 feet", "", "", ""]
const Q22A = ["86 F (30 C)", "", "", ""]
const Q23A = ["122 F (50 C)", "", "", ""]
const Q24A = ["The plastic piping or tubing is not subject to external loading stresses created by other piping, appliances, or equipment.", "", "", ""]
const Q25A = ["ANSI/LC 1/CSA 6.26", "", "", ""]
const Q26A = ["CSA publication CGA Certification Laboratory Requirement LAB-009", "", "", ""]
const Q27A = ["No", "", "", ""]
const Q28A = ["Volume and pressure at that point of use", "", "", ""]
const Q29A = ["1.0 in w.c", "", "", ""]
const Q30A = ["The appliance and either the termination of the utility installation or the last-stage regulator", "", "", ""]
const Q31A = ["The use of the tables found in Annex A, or by method of calculation outlined in Annex A", "", "", ""]
const Q32A = ["Ensure that the appliance will not be overpressured under conditions of no flow", "", "", ""]
const Q33A = ["Matches downstream load requirements", "", "", ""]
const Q34A = ["By method of calculation outlined in Annex B", "", "", ""]
const Q35A = ["0.60", "", "", ""]
const Q36A = ["1.52", "", "", ""]
const Q37A = ["The resistance of bends, fittings and valves", "", "", ""]
const Q38A = ["NPS 1/2", "", "", ""]
const Q39A = ["25 ft in length", "", "", ""]
const Q40A = ["NPS 1/2", "", "", ""]
const Q41A = ["Include an allowance for known future extensions", "", "", ""]
const Q42A = ["The appliance manufacturer", "", "", ""]
const Q43A = ["Authority having jurisdiction", "", "", ""]
const Q44A = ["The appliance rating plate", "", "", ""]
const Q45A = ["A pressure regulator", "", "", ""]
const Q46A = ["Bends, fittings and valves", "", "", ""]
const Q47A = ["Clause 6.3", "", "", ""]
const Q48A = ["24 inches", "", "", ""]
const Q49A = ["Inspected and tested in accordance with Clause 6.22 in their final position prior to being concealed", "", "", ""]
const Q50A = ["All answers listed", "", "", ""]
const Q51A = ["Corrosive chemical is used", "", "", ""]
const Q52A = ["Encasing the piping or tubing in ducts so that there is free air space around the pipe or tube. Such a duct shall be ventilated.", "", "", ""]
const Q53A = ["1 inch in diameter", "", "", ""]
const Q54A = ["Clause 6.7.6", "", "", ""]
const Q55A = ["Cutting burrs, threading burrs, scale and defects", "", "", ""]
const Q56A = ["Reamed", "", "", ""]
const Q57A = ["Other piping or tubing", "", "", ""]
const Q58A = ["That required for the purpose for which it is intended", "", "", ""]
const Q59A = ["A back check valve, or other suitable equipment", "", "", ""]
const Q60A = ["A low-pressure indicator", "", "", ""]
const Q61A = ["Clause 6.8.8", "", "", ""]
const Q62A = ["The branch line does not exceed 50% of the pipe diameter of the gas supply header, and in no case, be less than NPS 3/4", "", "", ""]
const Q63A = ["Galvanic action between the piping or tubing and the supports", "", "", ""]
const Q64A = ["All of these", "", "", ""]
const Q65A = ["NPS 2 1/2", "", "", ""]
const Q66A = ["Registered under the applicable provincial or territorial legislation", "", "", ""]
const Q67A = ["Clause 7.10.2 of CSA Z662", "", "", ""]
const Q68A = ["Tapered", "", "", ""]
const Q69A = ["Male threads of a metal pipe", "", "", ""]
const Q70A = ["Neoprene or other similar material", "", "", ""]
const Q71A = ["The service conditions to which it can be subjected", "", "", ""]
const Q72A = ["A press-connect fitting", "", "", ""]
const Q73A = ["Steel", "", "", ""]
const Q74A = ["Heat fusion, electro fusion, or mechanical methods", "", "", ""]
const Q75A = ["The same size as the piping which supplies it", "", "", ""]
const Q76A = ["Where approved", "", "", ""]
const Q77A = ["Secured in place (non-removable)", "", "", ""]
const Q78A = ["Indoors, in a residential building", "", "", ""]
const Q79A = ["ANSI Z21.90/CSA 6.24", "", "", ""]
const Q80A = ["ANSI Z21.41/CSA 6.9", "", "", ""]
const Q81A = ["No undue strain on the connection", "", "", ""]
const Q82A = ["a plugged valve", "", "", ""]
const Q83A = ["1 inch", "", "", ""]
const Q84A = ["As close as practicable", "", "", ""]
const Q85A = ["The final drop serving an appliance", "", "", ""]
const Q86A = ["A range, clothes dryer, gas log, or room heater", "", "", ""]
const Q87A = ["NPS 2", "", "", ""]
const Q88A = ["Cleaning and emptying", "", "", ""]
const Q89A = ["Capped", "", "", ""]
const Q90A = ["Condensation", "", "", ""]
const Q91A = ["Replaced", "", "", ""]
const Q92A = ["Nested", "", "", ""]
const Q93A = ["Not be used", "", "", ""]
const Q94A = ["A swing joint", "", "", ""]
const Q95A = ["Low voltage", "", "", ""]
const Q96A = ["A street elbow, close nipple, or street tee", "", "", ""]
const Q97A = ["NPS 1/2", "", "", ""]
const Q98A = ["Welding", "", "", ""]
const Q99A = ["Brazing", "", "", ""]
const Q100A = ["24 inches", "", "", ""]
const Q101A = ["A sag in the piping or tubing", "", "", ""]
const Q102A = ["Any material that can damage the piping or tubing", "", "", ""]
const Q103A = ["A foundation, wall or building.", "", "", ""]
const Q104A = ["The authority having jurisdiction", "", "", ""]
const Q105A = ["A watertight seal", "", "", ""]
const Q106A = ["A sleeve", "", "", ""]
const Q107A = ["Paving extends 25 ft or more from the building", "", "", ""]
const Q108A = ["Plastic", "", "", ""]
const Q109A = ["A shut-off valve situated above ground", "", "", ""]
const Q110A = ["Plastic piping or tubing", "", "", ""]
const Q111A = ["Painting or coating", "", "", ""]
const Q112A = ["Corrosion", "", "", ""]
const Q113A = ["Expansion, contraction, jarring, vibration, and settling", "", "", ""]
const Q114A = ["1.75 inches", "", "", ""]
const Q115A = ["Appliance doors or covers", "", "", ""]
const Q116A = ["Galvanic corrosion", "", "", ""]
const Q117A = ["Damage and galvanic action", "", "", ""]
const Q118A = ["Sleeved", "", "", ""]
const Q119A = ["Excessive heat and harmful chemicals", "", "", ""]
const Q120A = ["Adequately supported", "", "", ""]
const Q121A = ["Direct sunlight", "", "", ""]
const Q122A = ["The manufacturer's certified installation instructions", "", "", ""]
const Q123A = ["Posts or guardrails", "", "", ""]
const Q124A = ["42 inches", "", "", ""]
const Q125A = ["36 inches", "", "", ""]
const Q126A = ["30 inches", "", "", ""]
const Q127A = ["1 inch", "", "", ""]
const Q128A = ["14 in w.c.", "", "", ""]
const Q129A = ["6 ft", "", "", ""]
const Q130A = ["Two or more gas meters", "", "", ""]
const Q131A = ["Its certified rating range", "", "", ""]
const Q132A = ["Valve train", "", "", ""]
const Q133A = ["The tubing is 1 inch OD or larger", "", "", ""]
const Q134A = ["Installed to provide protection from damage", "", "", ""]
const Q135A = ["Valve seat", "", "", ""]
const Q136A = ["The point of entry to the adjoining building", "", "", ""]
const Q137A = ["Propane", "", "", ""]
const Q138A = ["Readily accessible", "", "", ""]
const Q139A = ["Capped", "", "", ""]
const Q140A = ["Shut off the gas supply", "", "", ""]
const Q141A = ["Clause 7.23.3", "", "", ""]
const Q142A = ["Mobile during operation, is portable, or requires isolation from vibration", "", "", ""]
const Q143A = ["10 ft", "", "", ""]
const Q144A = ["Not be permitted", "", "", ""]
const Q145A = ["At a minimum", "", "", ""]
const Q146A = ["The gas hose must be replaced immediately", "", "", ""]
const Q147A = ["Concealed location", "", "", ""]
const Q148A = ["ULC C536", "", "", ""]
const Q149A = ["The shut-off valves on the gas hose", "", "", ""]
const Q150A = ["An appliance located within a building", "", "", ""]
const Q151A = ["ANSI Z20.51/CSA 2.5", "", "", ""]
const Q152A = ["A wall, floor, ceiling or partition", "", "", ""]
const Q153A = ["ANSI Z21.101/CSA 8.5", "", "", ""]
const Q154A = ["2 ft", "", "", ""]
const Q155A = ["ANSI Z21.75/CSA 6.27", "", "", ""]
const Q156A = ["Isolated", "", "", ""]
const Q157A = ["20 ft", "", "", ""]
const Q158A = ["Clause 6.22.2", "", "", ""]
const Q159A = ["Purging the gas to the outdoors in accordance with Clause 6.23.7", "", "", ""]
const Q160A = ["NPS 4", "", "", ""]
const Q161A = ["Annex H", "", "", ""]
const Q162A = ["Constant attendance", "", "", ""]
const Q163A = ["10 ft", "", "", ""]
const Q164A = ["Smoking", "", "", ""]
const Q165A = ["All piping and tubing systems and hose have been purged", "", "", ""]
const Q166A = ["NPS 1", "", "", ""]
